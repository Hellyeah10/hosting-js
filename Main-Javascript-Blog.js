...
$(document).ready(function() {
    var e = $("a.blog-pager-newer").attr("href");
    $("a.blog-pager-newer").load(e + " .post-title:first", function() {
        var e = $("a.blog-pager-newer").text();
        $("a.blog-pager-newer").html('<h7 class="new">' + e + "<h7>")
    });
    var t = $("a.blog-pager-older").attr("href");
    $("a.blog-pager-older").load(t + " .post-title:first", function() {
        var e = $("a.blog-pager-older").text();
        $("a.blog-pager-older").html('<h7>' + e + "</h7>")
    })
});
...
var $toTop = $(".shareOnscroll");
$(window).scroll(function() {
    $(this).scrollTop() > 400 ? $toTop.fadeIn() : $toTop.is(":visible") && $toTop.fadeOut()
});
